...
(function () {
  ...
  // --- CÓDIGO CORREGIDO PARA BORRAR PÁGINA ---
  // Esperamos a que el visor esté completamente cargado para asegurarnos de que PDFViewerApplication existe.
  document.addEventListener("webviewerloaded", () => {
    // El ID del botón que añadimos en viewer.html es "deletePage"
